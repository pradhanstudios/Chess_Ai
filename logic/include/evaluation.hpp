...
#define S(mg, eg) ((mg * 0x10000) + eg) // compiler hates (mg << 16) | eg

// not used for piece square tables
...
const int PIECE_SQUARE_TABLES[384] = {
        ...
        S(-46, 135), S(-23, 126), S(51, 90), S(76, 74), S(100, 70), S(62, 119), S(72, 121), S(67, 134), 
        S(0, 0), S(0, 0), S(0, 0), S(0, 0), S(0, 0), S(0, 0), S(0, 0), S(0, 0), 
        // knight
        ...
        S(176, 230), S(180, 290), S(213, 282), S(262, 301), S(235, 301), S(212, 310), S(169, 292), S(138, 248), 
        // bishop
        ...
        S(704, 1022), S(709, 1031), S(694, 1039), S(706, 1058), S(705, 1058), S(699, 1062), S(694, 1046), S(694, 1041), 
        S(737, 992), S(730, 1011), S(723, 1039), S(715, 1066), S(715, 1068), S(714, 1054), S(711, 1049), S(702, 1046), 
