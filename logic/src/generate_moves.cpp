...
void generate_legal_moves(Board chess_board, std::array<magic_structure, 64> ROOK_MAGICS, std::array<magic_structure, 64> BISHOP_MAGICS, std::vector<Move> &moves) { // should be reserved to size 218
    // std::cout << "im hjere" << std::endl;
    printf("oh yea\n");
    // pawns
